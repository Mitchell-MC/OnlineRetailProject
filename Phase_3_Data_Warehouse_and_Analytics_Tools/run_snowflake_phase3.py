#!/usr/bin/env python3
"""
Script to execute the Phase 3 SQL file against Snowflake
"""
...
def execute_sql_statements(conn, sql_content):
    ...
    print("🚀 Starting Phase 3 Data Warehouse Setup...")
    print("=" * 60)
    ...
    print("=" * 60)
    print("🎉 Phase 3 Data Warehouse Setup Complete!")
    ...
    try:
        ...
        # Check key tables
        key_tables = ['STG_EVENTS_COMBINED', 'CUSTOMER_360_PROFILE', 'USER_PRODUCT_RECOMMENDATIONS']
...
def main():
    ...
    print("🔍 Phase 3 Data Warehouse Setup")
    print("=" * 50)
    
    # Read the SQL file
    sql_file_path = "snowflake_phase3_simple.sql"
