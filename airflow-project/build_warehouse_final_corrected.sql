-- ===================================================================
-- FINAL CORRECTED DATA WAREHOUSE BUILD - PHASE 3
-- This script is corrected to match the actual table structure
-- ===================================================================
...
-- View 2: User Behavior Analytics (Corrected)
...
-- ===================================================================
-- STEP 3: CREATE PRODUCT RECOMMENDATIONS (Corrected)
-- ===================================================================
...
-- Step 4: Match users to recommendations (Corrected)
SELECT
...
-- ===================================================================
-- STEP 4: CREATE OPERATIONAL DASHBOARD TABLES (Corrected)
-- ===================================================================
...
-- Table 3: User Segments for Marketing (Corrected)
CREATE OR REPLACE TABLE USER_SEGMENTS AS
SELECT 
    c360.USER_ID as user_id,
    CASE 
        WHEN c360.TOTAL_SPEND >= 1000 THEN 'VIP'
        WHEN c360.TOTAL_SPEND >= 500 THEN 'Premium'
        WHEN c360.TOTAL_SPEND >= 100 THEN 'Regular'
        ELSE 'New'
    END as segment,
    c360.TOTAL_SPEND as total_spend,
    c360.TOTAL_PURCHASES as total_purchases,
